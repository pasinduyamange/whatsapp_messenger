      ...
      body: CustomScrollView(
        slivers: [
          SliverPersistentHeader(
            delegate: SliverPresistentDelegate(user),
            pinned: true,
          ),
          // lets create a long list to make the content scrllable
          SliverToBoxAdapter(
            child: Column(
              children: [
                Container(
                ...
                const CustomListTile(
                  title: 'Encryption',
                  subTitle:
                      'Message and calls are end-to-end encrypted, Tap to verify.',
                  leading: Icons.lock,
                ),
                const CustomListTile(
...
class SliverPresistentDelegate extends SliverPersistentHeaderDelegate {
  final UserModel user;
  ...
  SliverPresistentDelegate(this.user);
